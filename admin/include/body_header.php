    ...
    <div class="layout-wrapper">
        ...
        <div class="header">
            ...
            <a href="index.php" class="logo">
                <img width="100" src="./img/logo.svg" alt="logo">
            </a>
            <!-- ./ Logo -->
            ...
            <div class="header-bar ms-auto">
                <ul class="navbar-nav justify-content-end">
                            ...
                            <div class="dropdown-menu-body">
                                <div class="list-group list-group-flush">
                                    <div class="list-group-item d-flex align-items-center">
                                        ...
                                        <a href="#" class="me-3 flex-shrink-0 ">
                                            <img src="./img/3.jpg" class="rounded" width="60" alt="...">
                                        </a>
                                        <div>
                                            <h6>Digital clock</h6>
                                ...
                                <div class="list-group list-group-flush">
                                    <div class="list-group-item d-flex align-items-center">
                                        ...
                                        <a href="#" class="me-3 flex-shrink-0 ">
                                            <img src="./img/4.jpg" class="rounded" width="60" alt="...">
                                        </a>
                                        <div>
                                            <h6>Toy Car</h6>
                                            <div>1 x $139.58</div>
                                ...
                                <div class="list-group list-group-flush">
                                    <div class="list-group-item d-flex align-items-center">
                                        ...
                                        <a href="#" class="me-3 flex-shrink-0 ">
                                            <img src="./img/5.jpg" class="rounded" width="60" alt="...">
                                        </a>
                                        <div>
                                            <h6>Sunglasses</h6>
                                            <div>2 x $50,90</div>
                                ...
                                <div class="list-group list-group-flush">
                                    <div class="list-group-item d-flex align-items-center">
                                        ...
                                        <a href="#" class="me-3 flex-shrink-0 ">
                                            <img src="./img/6.jpg" class="rounded" width="60" alt="...">
                                        </a>
                                        <div>
                                            <h6>Cake</h6>
                                            <div>1 x $10,50</div>
                    ...
                    <li class="nav-item ms-3">
                        <a class=" btn btn-primary btn-icon" href="../index.php">
                            <i class=" bi bi-plus-circle"></i> Back to Home
                        </a>
                    </li>
                </ul>
            </div>
