...
include_once './include/body_header.php';
?>
<!-- content -->
<div class="content ">
                        ...
                        <div>
                            <div class="d-flex align-items-center mb-3">
                                <div class="avatar me-3">
                                    <img src="./img/women_avatar5.jpg" class="rounded-circle" alt="image">
                                </div>
                                <div>
                    ...
                    <div class="list-group list-group-flush">
                        <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                            <div class="d-flex flex-grow-1 align-items-center">
                                <img width="45" class="me-3" src="./img/united-states-of-america.svg" alt="...">
                        ...
                        <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                            <div class="d-flex flex-grow-1 align-items-center">
                                <img width="45" class="me-3" src="./img/venezuela.svg" alt="...">
                                <span>Venezuela</span>
                            </div>
                            <span>$1.064,75</span>
                        </div>
                        <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                            <div class="d-flex flex-grow-1 align-items-center">
                                <img width="45" class="me-3" src="./img/salvador.svg" alt="...">
                                <span>Salvador</span>
                            </div>
                            <span>$1.055,98</span>
                        </div>
                        <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                            <div class="d-flex flex-grow-1 align-items-center">
                                <img width="45" class="me-3" src="./img/russia.svg" alt="...">
                                <span>Russia</span>
                            </div>
                            <span>$1.042,00</span>
                        </div>
                        ...
                        <table class="table table-custom mb-0" id="recent-products">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a href="#">
                                            <img src="./img/10.jpg" class="rounded" width="40" alt="...">
                                        </a>
                                    </td>
                                    <td>Cookie</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#">
                                            <img src="./img/7.jpg" class="rounded" width="40" alt="...">
                                        </a>
                                    </td>
                                    <td>Glass</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#">
                                            <img src="./img/8.jpg" class="rounded" width="40" alt="...">
                                        </a>
                                    </td>
                                    <td>Headphone</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#">
                                            <img src="./img/9.jpg" class="rounded" width="40" alt="...">
                                        </a>
                                    </td>
                                    <td>Perfume</td>
                                    <td>
