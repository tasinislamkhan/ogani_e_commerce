...
<head>
    ...
    z = e.createElement(r);
    z.defer = !0, z.src = "/cdn-cgi/zaraz/s.js?z=" + btoa(encodeURIComponent(JSON
    .stringify(
...
<body>
        ...
        <div class="humberger__menu__contact">
            <ul>
                <li><i class="fa fa-envelope"></i> <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                        data-cfemail="8ee6ebe2e2e1ceede1e2e1fce2e7eca0ede1e3">[email&#160;protected]</a></li>
                <li>This Site is Under Development</li>
            </ul>
        </div>
    </div>
                        ...
                        <div class="header__top__left">
                            <ul>
                                <li><i class="fa fa-envelope"></i> <a href="/cdn-cgi/l/email-protection"
                                        class="__cf_email__"
                                        data-cfemail="f9919c959596b99a9695968b95909bd79a9694">[email&#160;protected]</a>
                                </li>
                                <li>This Site is Under Development</li>
                            </ul>
                        </div>
                    ...
                    <div class="footer__about">
                        ...
                        <ul>
                            ...
                            <li>Email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                    data-cfemail="721a171e1e1d32111d1e1d001e1b105c111d1f">[email&#160;protected]</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="footer__copyright">
                        ...
                        <div class="footer__copyright__payment"><img
                                src="img/xpayment-item.png.pagespeed.ic.fk3ziISga0.webp" alt=""></div>
                    </div>
                </div>
            </div>
    ...
    <script defer
        ...
        data-cf-beacon='{"rayId":"6de1860c28074b80","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2021.12.0","si":100}'
